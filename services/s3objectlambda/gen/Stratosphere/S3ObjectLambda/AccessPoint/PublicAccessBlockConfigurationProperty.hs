module Stratosphere.S3ObjectLambda.AccessPoint.PublicAccessBlockConfigurationProperty (
...
data PublicAccessBlockConfigurationProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3objectlambda-accesspoint-publicaccessblockconfiguration.html>
    PublicAccessBlockConfigurationProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3objectlambda-accesspoint-publicaccessblockconfiguration.html#cfn-s3objectlambda-accesspoint-publicaccessblockconfiguration-blockpublicacls>
...
instance ToResourceProperties PublicAccessBlockConfigurationProperty where
  toResourceProperties PublicAccessBlockConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::S3ObjectLambda::AccessPoint.PublicAccessBlockConfiguration",
