module Stratosphere.SageMaker.UserProfile.IdleSettingsProperty (
...
data IdleSettingsProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-userprofile-idlesettings.html>
    IdleSettingsProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sagemaker-userprofile-idlesettings.html#cfn-sagemaker-userprofile-idlesettings-idletimeoutinminutes>
...
instance ToResourceProperties IdleSettingsProperty where
  toResourceProperties IdleSettingsProperty {..}
    = ResourceProperties
        {awsType = "AWS::SageMaker::UserProfile.IdleSettings",
