...
mkCluster instanceGroups
  = Cluster
      {haddock_workaround_ = (), instanceGroups = instanceGroups,
       clusterName = Prelude.Nothing, nodeRecovery = Prelude.Nothing,
       orchestrator = Prelude.Nothing, tags = Prelude.Nothing,
