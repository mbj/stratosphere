...
mkDashboard ::
  Value Prelude.Text
  -> Value Prelude.Text -> DashboardSourceEntityProperty -> Dashboard
mkDashboard awsAccountId dashboardId sourceEntity
  = Dashboard
      {awsAccountId = awsAccountId, dashboardId = dashboardId,
       sourceEntity = sourceEntity,
       dashboardPublishOptions = Prelude.Nothing, name = Prelude.Nothing,
...
instance Property "SourceEntity" Dashboard where
  ...
  set newValue Dashboard {..}
    = Dashboard {sourceEntity = newValue, ..}
