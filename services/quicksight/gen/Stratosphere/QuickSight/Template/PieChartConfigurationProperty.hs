module Stratosphere.QuickSight.Template.PieChartConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.DonutOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.LegendOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PieChartFieldWellsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PieChartSortConfigurationProperty as Exports
...
data PieChartConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-piechartconfiguration.html>
    PieChartConfigurationProperty {haddock_workaround_ :: (),
                                   ...
                                   -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-piechartconfiguration.html#cfn-quicksight-template-piechartconfiguration-interactions>
...
instance ToResourceProperties PieChartConfigurationProperty where
  toResourceProperties PieChartConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.PieChartConfiguration",
