module Stratosphere.QuickSight.Template.NumericFormatConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.CurrencyDisplayFormatConfigurationProperty as Exports
...
instance ToResourceProperties NumericFormatConfigurationProperty where
  toResourceProperties NumericFormatConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.NumericFormatConfiguration",
