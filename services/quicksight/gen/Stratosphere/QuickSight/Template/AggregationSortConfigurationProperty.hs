module Stratosphere.QuickSight.Template.AggregationSortConfigurationProperty (
...
data AggregationSortConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-aggregationsortconfiguration.html>
    AggregationSortConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties AggregationSortConfigurationProperty where
  toResourceProperties AggregationSortConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.AggregationSortConfiguration",
