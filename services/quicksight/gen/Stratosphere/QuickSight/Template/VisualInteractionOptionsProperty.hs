module Stratosphere.QuickSight.Template.VisualInteractionOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ContextMenuOptionProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.VisualMenuOptionProperty as Exports
...
instance ToResourceProperties VisualInteractionOptionsProperty where
  toResourceProperties VisualInteractionOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.VisualInteractionOptions",
