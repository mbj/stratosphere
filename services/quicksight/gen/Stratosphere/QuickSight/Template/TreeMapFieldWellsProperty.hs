module Stratosphere.QuickSight.Template.TreeMapFieldWellsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.TreeMapAggregatedFieldWellsProperty as Exports
...
instance ToResourceProperties TreeMapFieldWellsProperty where
  toResourceProperties TreeMapFieldWellsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.TreeMapFieldWells",
