module Stratosphere.QuickSight.Template.VisualCustomActionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.VisualCustomActionOperationProperty as Exports
...
instance ToResourceProperties VisualCustomActionProperty where
  toResourceProperties VisualCustomActionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.VisualCustomAction",
