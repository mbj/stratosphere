module Stratosphere.QuickSight.Template.DefaultFilterDropDownControlOptionsProperty (
...
instance ToResourceProperties DefaultFilterDropDownControlOptionsProperty where
  toResourceProperties
    DefaultFilterDropDownControlOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.DefaultFilterDropDownControlOptions",
