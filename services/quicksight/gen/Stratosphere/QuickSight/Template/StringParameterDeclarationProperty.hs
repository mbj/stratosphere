module Stratosphere.QuickSight.Template.StringParameterDeclarationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.StringDefaultValuesProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.StringValueWhenUnsetConfigurationProperty as Exports
...
instance ToResourceProperties StringParameterDeclarationProperty where
  toResourceProperties StringParameterDeclarationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.StringParameterDeclaration",
