module Stratosphere.QuickSight.Template.DataLabelOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.DataLabelTypeProperty as Exports
...
data DataLabelOptionsProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-datalabeloptions.html>
    DataLabelOptionsProperty {haddock_workaround_ :: (),
                              ...
                              categoryLabelVisibility :: (Prelude.Maybe JSON.Object),
                              ...
                              measureLabelVisibility :: (Prelude.Maybe JSON.Object),
                              ...
                              totalsVisibility :: (Prelude.Maybe JSON.Object),
...
instance ToResourceProperties DataLabelOptionsProperty where
  toResourceProperties DataLabelOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.DataLabelOptions",
...
instance Property "CategoryLabelVisibility" DataLabelOptionsProperty where
  type PropertyType "CategoryLabelVisibility" DataLabelOptionsProperty = JSON.Object
...
instance Property "MeasureLabelVisibility" DataLabelOptionsProperty where
  type PropertyType "MeasureLabelVisibility" DataLabelOptionsProperty = JSON.Object
  set newValue DataLabelOptionsProperty {..}
    = DataLabelOptionsProperty
...
instance Property "TotalsVisibility" DataLabelOptionsProperty where
  type PropertyType "TotalsVisibility" DataLabelOptionsProperty = JSON.Object
  set newValue DataLabelOptionsProperty {..}
    = DataLabelOptionsProperty
        {totalsVisibility = Prelude.pure newValue, ..}
instance Property "Visibility" DataLabelOptionsProperty where
  type PropertyType "Visibility" DataLabelOptionsProperty = JSON.Object
  set newValue DataLabelOptionsProperty {..}
