module Stratosphere.QuickSight.Template.PercentageDisplayFormatConfigurationProperty (
...
data PercentageDisplayFormatConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-percentagedisplayformatconfiguration.html>
    PercentageDisplayFormatConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties PercentageDisplayFormatConfigurationProperty where
  toResourceProperties
    PercentageDisplayFormatConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.PercentageDisplayFormatConfiguration",
