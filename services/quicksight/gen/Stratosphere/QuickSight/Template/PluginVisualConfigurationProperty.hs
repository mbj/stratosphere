module Stratosphere.QuickSight.Template.PluginVisualConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PluginVisualFieldWellProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PluginVisualOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PluginVisualSortConfigurationProperty as Exports
...
instance ToResourceProperties PluginVisualConfigurationProperty where
  toResourceProperties PluginVisualConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.PluginVisualConfiguration",
