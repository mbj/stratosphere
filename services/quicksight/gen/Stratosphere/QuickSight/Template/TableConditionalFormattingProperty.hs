module Stratosphere.QuickSight.Template.TableConditionalFormattingProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.TableConditionalFormattingOptionProperty as Exports
...
instance ToResourceProperties TableConditionalFormattingProperty where
  toResourceProperties TableConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.TableConditionalFormatting",
