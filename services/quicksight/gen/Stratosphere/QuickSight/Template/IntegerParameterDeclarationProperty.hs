module Stratosphere.QuickSight.Template.IntegerParameterDeclarationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.IntegerDefaultValuesProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.IntegerValueWhenUnsetConfigurationProperty as Exports
...
instance ToResourceProperties IntegerParameterDeclarationProperty where
  toResourceProperties IntegerParameterDeclarationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.IntegerParameterDeclaration",
