module Stratosphere.QuickSight.Template.ListControlDisplayOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ListControlSearchOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ListControlSelectAllOptionsProperty as Exports
...
instance ToResourceProperties ListControlDisplayOptionsProperty where
  toResourceProperties ListControlDisplayOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ListControlDisplayOptions",
