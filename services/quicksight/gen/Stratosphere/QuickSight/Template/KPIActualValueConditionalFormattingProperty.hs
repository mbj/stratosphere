module Stratosphere.QuickSight.Template.KPIActualValueConditionalFormattingProperty (
...
instance ToResourceProperties KPIActualValueConditionalFormattingProperty where
  toResourceProperties
    KPIActualValueConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.KPIActualValueConditionalFormatting",
