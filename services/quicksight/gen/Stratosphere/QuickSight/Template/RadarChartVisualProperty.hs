module Stratosphere.QuickSight.Template.RadarChartVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.RadarChartConfigurationProperty as Exports
...
data RadarChartVisualProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-radarchartvisual.html>
    RadarChartVisualProperty {haddock_workaround_ :: (),
                              ...
                              -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-radarchartvisual.html#cfn-quicksight-template-radarchartvisual-visualcontentalttext>
...
instance ToResourceProperties RadarChartVisualProperty where
  toResourceProperties RadarChartVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.RadarChartVisual",
