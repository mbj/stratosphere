module Stratosphere.QuickSight.Template.SeriesItemProperty (
        module Exports, SeriesItemProperty(..), mkSeriesItemProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Template.DataFieldSeriesItemProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FieldSeriesItemProperty as Exports
...
instance ToResourceProperties SeriesItemProperty where
  toResourceProperties SeriesItemProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.SeriesItem",
