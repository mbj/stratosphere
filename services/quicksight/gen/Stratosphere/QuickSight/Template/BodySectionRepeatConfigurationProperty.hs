module Stratosphere.QuickSight.Template.BodySectionRepeatConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.BodySectionRepeatDimensionConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.BodySectionRepeatPageBreakConfigurationProperty as Exports
...
instance ToResourceProperties BodySectionRepeatConfigurationProperty where
  toResourceProperties BodySectionRepeatConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.BodySectionRepeatConfiguration",
