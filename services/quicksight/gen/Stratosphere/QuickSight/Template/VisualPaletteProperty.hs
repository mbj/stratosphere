module Stratosphere.QuickSight.Template.VisualPaletteProperty (
        module Exports, VisualPaletteProperty(..), mkVisualPaletteProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Template.DataPathColorProperty as Exports
...
instance ToResourceProperties VisualPaletteProperty where
  toResourceProperties VisualPaletteProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.VisualPalette",
