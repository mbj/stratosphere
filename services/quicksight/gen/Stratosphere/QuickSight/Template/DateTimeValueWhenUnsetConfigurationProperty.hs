module Stratosphere.QuickSight.Template.DateTimeValueWhenUnsetConfigurationProperty (
...
instance ToResourceProperties DateTimeValueWhenUnsetConfigurationProperty where
  toResourceProperties
    DateTimeValueWhenUnsetConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.DateTimeValueWhenUnsetConfiguration",
