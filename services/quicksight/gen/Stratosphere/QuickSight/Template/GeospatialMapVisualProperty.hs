module Stratosphere.QuickSight.Template.GeospatialMapVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.GeospatialMapConfigurationProperty as Exports
...
instance ToResourceProperties GeospatialMapVisualProperty where
  toResourceProperties GeospatialMapVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.GeospatialMapVisual",
