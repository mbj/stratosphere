module Stratosphere.QuickSight.Template.ClusterMarkerConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ClusterMarkerProperty as Exports
...
instance ToResourceProperties ClusterMarkerConfigurationProperty where
  toResourceProperties ClusterMarkerConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ClusterMarkerConfiguration",
