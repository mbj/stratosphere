module Stratosphere.QuickSight.Template.ScatterPlotVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ScatterPlotConfigurationProperty as Exports
...
instance ToResourceProperties ScatterPlotVisualProperty where
  toResourceProperties ScatterPlotVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ScatterPlotVisual",
