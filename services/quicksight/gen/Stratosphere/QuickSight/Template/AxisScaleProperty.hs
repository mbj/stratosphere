module Stratosphere.QuickSight.Template.AxisScaleProperty (
        module Exports, AxisScaleProperty(..), mkAxisScaleProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Template.AxisLinearScaleProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.AxisLogarithmicScaleProperty as Exports
...
instance ToResourceProperties AxisScaleProperty where
  toResourceProperties AxisScaleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.AxisScale",
