module Stratosphere.QuickSight.Template.PluginVisualTableQuerySortProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PluginVisualItemsLimitConfigurationProperty as Exports
...
instance ToResourceProperties PluginVisualTableQuerySortProperty where
  toResourceProperties PluginVisualTableQuerySortProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.PluginVisualTableQuerySort",
