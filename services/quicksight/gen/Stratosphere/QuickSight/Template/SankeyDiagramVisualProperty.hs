module Stratosphere.QuickSight.Template.SankeyDiagramVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.SankeyDiagramChartConfigurationProperty as Exports
...
instance ToResourceProperties SankeyDiagramVisualProperty where
  toResourceProperties SankeyDiagramVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.SankeyDiagramVisual",
