module Stratosphere.QuickSight.Template.ConditionalFormattingCustomIconConditionProperty (
        module Exports,
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ConditionalFormattingCustomIconOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ConditionalFormattingIconDisplayConfigurationProperty as Exports
...
instance ToResourceProperties ConditionalFormattingCustomIconConditionProperty where
  toResourceProperties
    ConditionalFormattingCustomIconConditionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ConditionalFormattingCustomIconCondition",
