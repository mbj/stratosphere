module Stratosphere.QuickSight.Template.TimeRangeFilterProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.TimeRangeFilterValueProperty as Exports
...
instance ToResourceProperties TimeRangeFilterProperty where
  toResourceProperties TimeRangeFilterProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.TimeRangeFilter",
