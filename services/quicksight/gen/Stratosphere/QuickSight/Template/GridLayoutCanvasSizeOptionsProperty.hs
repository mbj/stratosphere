module Stratosphere.QuickSight.Template.GridLayoutCanvasSizeOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.GridLayoutScreenCanvasSizeOptionsProperty as Exports
...
instance ToResourceProperties GridLayoutCanvasSizeOptionsProperty where
  toResourceProperties GridLayoutCanvasSizeOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.GridLayoutCanvasSizeOptions",
