module Stratosphere.QuickSight.Template.ScatterPlotCategoricallyAggregatedFieldWellsProperty (
        module Exports,
...
instance ToResourceProperties ScatterPlotCategoricallyAggregatedFieldWellsProperty where
  toResourceProperties
    ScatterPlotCategoricallyAggregatedFieldWellsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ScatterPlotCategoricallyAggregatedFieldWells",
