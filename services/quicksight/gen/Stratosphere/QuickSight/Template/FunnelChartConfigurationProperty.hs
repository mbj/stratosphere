module Stratosphere.QuickSight.Template.FunnelChartConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FunnelChartDataLabelOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FunnelChartFieldWellsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FunnelChartSortConfigurationProperty as Exports
...
instance ToResourceProperties FunnelChartConfigurationProperty where
  toResourceProperties FunnelChartConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.FunnelChartConfiguration",
