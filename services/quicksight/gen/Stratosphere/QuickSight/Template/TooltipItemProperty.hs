module Stratosphere.QuickSight.Template.TooltipItemProperty (
        module Exports, TooltipItemProperty(..), mkTooltipItemProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ColumnTooltipItemProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FieldTooltipItemProperty as Exports
...
instance ToResourceProperties TooltipItemProperty where
  toResourceProperties TooltipItemProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.TooltipItem",
