module Stratosphere.QuickSight.Template.ConditionalFormattingIconDisplayConfigurationProperty (
...
instance ToResourceProperties ConditionalFormattingIconDisplayConfigurationProperty where
  toResourceProperties
    ConditionalFormattingIconDisplayConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ConditionalFormattingIconDisplayConfiguration",
