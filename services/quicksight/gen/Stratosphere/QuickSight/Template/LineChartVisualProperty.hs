module Stratosphere.QuickSight.Template.LineChartVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.LineChartConfigurationProperty as Exports
...
instance ToResourceProperties LineChartVisualProperty where
  toResourceProperties LineChartVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.LineChartVisual",
