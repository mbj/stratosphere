module Stratosphere.QuickSight.Template.KPIProgressBarConditionalFormattingProperty (
...
instance ToResourceProperties KPIProgressBarConditionalFormattingProperty where
  toResourceProperties
    KPIProgressBarConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.KPIProgressBarConditionalFormatting",
