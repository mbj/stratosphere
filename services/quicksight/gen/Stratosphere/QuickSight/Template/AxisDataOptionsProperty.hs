module Stratosphere.QuickSight.Template.AxisDataOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.DateAxisOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.NumericAxisOptionsProperty as Exports
...
instance ToResourceProperties AxisDataOptionsProperty where
  toResourceProperties AxisDataOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.AxisDataOptions",
