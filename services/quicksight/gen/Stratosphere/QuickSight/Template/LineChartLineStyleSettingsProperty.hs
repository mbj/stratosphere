module Stratosphere.QuickSight.Template.LineChartLineStyleSettingsProperty (
...
data LineChartLineStyleSettingsProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-linechartlinestylesettings.html>
    LineChartLineStyleSettingsProperty {haddock_workaround_ :: (),
                                        ...
                                        lineVisibility :: (Prelude.Maybe JSON.Object),
...
instance Property "LineVisibility" LineChartLineStyleSettingsProperty where
  type PropertyType "LineVisibility" LineChartLineStyleSettingsProperty = JSON.Object
  set newValue LineChartLineStyleSettingsProperty {..}
    = LineChartLineStyleSettingsProperty
