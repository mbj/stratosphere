module Stratosphere.QuickSight.Template.KPIOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.KPISparklineOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.KPIVisualLayoutOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ProgressBarOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.SecondaryValueOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.TrendArrowOptionsProperty as Exports
...
instance ToResourceProperties KPIOptionsProperty where
  toResourceProperties KPIOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.KPIOptions",
