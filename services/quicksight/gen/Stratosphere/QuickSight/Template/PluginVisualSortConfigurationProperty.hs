module Stratosphere.QuickSight.Template.PluginVisualSortConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.PluginVisualTableQuerySortProperty as Exports
...
instance ToResourceProperties PluginVisualSortConfigurationProperty where
  toResourceProperties PluginVisualSortConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.PluginVisualSortConfiguration",
