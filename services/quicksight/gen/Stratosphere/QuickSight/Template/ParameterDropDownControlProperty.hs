module Stratosphere.QuickSight.Template.ParameterDropDownControlProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ParameterSelectableValuesProperty as Exports
...
instance ToResourceProperties ParameterDropDownControlProperty where
  toResourceProperties ParameterDropDownControlProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.ParameterDropDownControl",
