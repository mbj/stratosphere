...
data PivotTableOptionsProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-pivottableoptions.html>
    PivotTableOptionsProperty {haddock_workaround_ :: (),
                               ...
                               collapsedRowDimensionsVisibility :: (Prelude.Maybe JSON.Object),
                               ...
                               columnNamesVisibility :: (Prelude.Maybe JSON.Object),
                               ...
                               singleMetricVisibility :: (Prelude.Maybe JSON.Object),
                               ...
                               toggleButtonsVisibility :: (Prelude.Maybe JSON.Object)}
...
instance Property "CollapsedRowDimensionsVisibility" PivotTableOptionsProperty where
  type PropertyType "CollapsedRowDimensionsVisibility" PivotTableOptionsProperty = JSON.Object
  set newValue PivotTableOptionsProperty {..}
    = PivotTableOptionsProperty
...
instance Property "ColumnNamesVisibility" PivotTableOptionsProperty where
  type PropertyType "ColumnNamesVisibility" PivotTableOptionsProperty = JSON.Object
  set newValue PivotTableOptionsProperty {..}
    = PivotTableOptionsProperty
...
instance Property "SingleMetricVisibility" PivotTableOptionsProperty where
  type PropertyType "SingleMetricVisibility" PivotTableOptionsProperty = JSON.Object
  set newValue PivotTableOptionsProperty {..}
    = PivotTableOptionsProperty
        {singleMetricVisibility = Prelude.pure newValue, ..}
instance Property "ToggleButtonsVisibility" PivotTableOptionsProperty where
  type PropertyType "ToggleButtonsVisibility" PivotTableOptionsProperty = JSON.Object
  set newValue PivotTableOptionsProperty {..}
    = PivotTableOptionsProperty
