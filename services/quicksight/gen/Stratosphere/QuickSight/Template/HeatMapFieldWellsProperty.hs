module Stratosphere.QuickSight.Template.HeatMapFieldWellsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.HeatMapAggregatedFieldWellsProperty as Exports
...
instance ToResourceProperties HeatMapFieldWellsProperty where
  toResourceProperties HeatMapFieldWellsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.HeatMapFieldWells",
