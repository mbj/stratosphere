module Stratosphere.QuickSight.Template.SheetDefinitionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Template.FilterControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.LayoutProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.ParameterControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.SheetControlLayoutProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.SheetImageProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.SheetTextBoxProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Template.VisualProperty as Exports
...
instance ToResourceProperties SheetDefinitionProperty where
  toResourceProperties SheetDefinitionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Template.SheetDefinition",
