module Stratosphere.QuickSight.Dashboard.BoxPlotVisualProperty (
        module Exports, BoxPlotVisualProperty(..), mkBoxPlotVisualProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.BoxPlotChartConfigurationProperty as Exports
...
instance ToResourceProperties BoxPlotVisualProperty where
  toResourceProperties BoxPlotVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.BoxPlotVisual",
