module Stratosphere.QuickSight.Dashboard.DecimalValueWhenUnsetConfigurationProperty (
...
instance ToResourceProperties DecimalValueWhenUnsetConfigurationProperty where
  toResourceProperties
    DecimalValueWhenUnsetConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DecimalValueWhenUnsetConfiguration",
