module Stratosphere.QuickSight.Dashboard.GeospatialHeatmapColorScaleProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GeospatialHeatmapDataColorProperty as Exports
...
instance ToResourceProperties GeospatialHeatmapColorScaleProperty where
  toResourceProperties GeospatialHeatmapColorScaleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GeospatialHeatmapColorScale",
