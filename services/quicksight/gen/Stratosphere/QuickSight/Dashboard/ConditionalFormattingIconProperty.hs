module Stratosphere.QuickSight.Dashboard.ConditionalFormattingIconProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ConditionalFormattingCustomIconConditionProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ConditionalFormattingIconSetProperty as Exports
...
data ConditionalFormattingIconProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-conditionalformattingicon.html>
    ConditionalFormattingIconProperty {haddock_workaround_ :: (),
                                       ...
                                       customCondition :: (Prelude.Maybe ConditionalFormattingCustomIconConditionProperty),
...
mkConditionalFormattingIconProperty
  = ConditionalFormattingIconProperty
      {haddock_workaround_ = (), customCondition = Prelude.Nothing,
...
instance ToResourceProperties ConditionalFormattingIconProperty where
  toResourceProperties ConditionalFormattingIconProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.ConditionalFormattingIcon",
