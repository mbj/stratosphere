module Stratosphere.QuickSight.Dashboard.LineSeriesAxisDisplayOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.MissingDataConfigurationProperty as Exports
...
instance ToResourceProperties LineSeriesAxisDisplayOptionsProperty where
  toResourceProperties LineSeriesAxisDisplayOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.LineSeriesAxisDisplayOptions",
