module Stratosphere.QuickSight.Dashboard.SingleAxisOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.YAxisOptionsProperty as Exports
...
instance ToResourceProperties SingleAxisOptionsProperty where
  toResourceProperties SingleAxisOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.SingleAxisOptions",
