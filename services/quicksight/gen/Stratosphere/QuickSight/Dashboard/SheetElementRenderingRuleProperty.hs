...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.SheetElementConfigurationOverridesProperty as Exports
...
instance ToResourceProperties SheetElementRenderingRuleProperty where
  toResourceProperties SheetElementRenderingRuleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.SheetElementRenderingRule",
