module Stratosphere.QuickSight.Dashboard.DateTimePickerControlDisplayOptionsProperty (
...
instance ToResourceProperties DateTimePickerControlDisplayOptionsProperty where
  toResourceProperties
    DateTimePickerControlDisplayOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DateTimePickerControlDisplayOptions",
