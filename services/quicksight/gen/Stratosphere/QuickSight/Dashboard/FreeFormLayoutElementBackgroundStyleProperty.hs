module Stratosphere.QuickSight.Dashboard.FreeFormLayoutElementBackgroundStyleProperty (
...
instance ToResourceProperties FreeFormLayoutElementBackgroundStyleProperty where
  toResourceProperties
    FreeFormLayoutElementBackgroundStyleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.FreeFormLayoutElementBackgroundStyle",
