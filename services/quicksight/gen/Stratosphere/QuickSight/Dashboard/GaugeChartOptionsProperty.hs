module Stratosphere.QuickSight.Dashboard.GaugeChartOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ArcAxisConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ArcConfigurationProperty as Exports
...
instance ToResourceProperties GaugeChartOptionsProperty where
  toResourceProperties GaugeChartOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GaugeChartOptions",
