module Stratosphere.QuickSight.Dashboard.BoxPlotStyleOptionsProperty (
...
data BoxPlotStyleOptionsProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-boxplotstyleoptions.html>
    BoxPlotStyleOptionsProperty {haddock_workaround_ :: (),
