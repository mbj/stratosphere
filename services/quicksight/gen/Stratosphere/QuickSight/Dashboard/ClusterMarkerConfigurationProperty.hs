module Stratosphere.QuickSight.Dashboard.ClusterMarkerConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ClusterMarkerProperty as Exports
...
instance ToResourceProperties ClusterMarkerConfigurationProperty where
  toResourceProperties ClusterMarkerConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.ClusterMarkerConfiguration",
