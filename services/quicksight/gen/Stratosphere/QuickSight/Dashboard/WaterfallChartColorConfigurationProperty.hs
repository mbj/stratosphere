module Stratosphere.QuickSight.Dashboard.WaterfallChartColorConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.WaterfallChartGroupColorConfigurationProperty as Exports
...
instance ToResourceProperties WaterfallChartColorConfigurationProperty where
  toResourceProperties WaterfallChartColorConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.WaterfallChartColorConfiguration",
