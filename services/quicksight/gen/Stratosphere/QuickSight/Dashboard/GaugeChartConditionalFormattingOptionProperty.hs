module Stratosphere.QuickSight.Dashboard.GaugeChartConditionalFormattingOptionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartArcConditionalFormattingProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartPrimaryValueConditionalFormattingProperty as Exports
...
instance ToResourceProperties GaugeChartConditionalFormattingOptionProperty where
  toResourceProperties
    GaugeChartConditionalFormattingOptionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GaugeChartConditionalFormattingOption",
