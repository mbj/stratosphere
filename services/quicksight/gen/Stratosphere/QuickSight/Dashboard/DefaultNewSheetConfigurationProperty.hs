module Stratosphere.QuickSight.Dashboard.DefaultNewSheetConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.DefaultInteractiveLayoutConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.DefaultPaginatedLayoutConfigurationProperty as Exports
...
data DefaultNewSheetConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-defaultnewsheetconfiguration.html>
    DefaultNewSheetConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties DefaultNewSheetConfigurationProperty where
  toResourceProperties DefaultNewSheetConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DefaultNewSheetConfiguration",
