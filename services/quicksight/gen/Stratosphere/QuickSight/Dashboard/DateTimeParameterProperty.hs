module Stratosphere.QuickSight.Dashboard.DateTimeParameterProperty (
...
mkDateTimeParameterProperty ::
  Value Prelude.Text
  -> ValueList (Value Prelude.Text) -> DateTimeParameterProperty
...
instance ToResourceProperties DateTimeParameterProperty where
  toResourceProperties DateTimeParameterProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DateTimeParameter",
...
instance Property "Values" DateTimeParameterProperty where
  type PropertyType "Values" DateTimeParameterProperty = ValueList (Value Prelude.Text)
  set newValue DateTimeParameterProperty {..}
