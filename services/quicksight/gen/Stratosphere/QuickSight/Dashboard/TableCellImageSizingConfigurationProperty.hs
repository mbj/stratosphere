module Stratosphere.QuickSight.Dashboard.TableCellImageSizingConfigurationProperty (
...
data TableCellImageSizingConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-tablecellimagesizingconfiguration.html>
    TableCellImageSizingConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties TableCellImageSizingConfigurationProperty where
  toResourceProperties TableCellImageSizingConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.TableCellImageSizingConfiguration",
