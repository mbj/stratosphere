module Stratosphere.QuickSight.Dashboard.LineChartDefaultSeriesSettingsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.LineChartLineStyleSettingsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.LineChartMarkerStyleSettingsProperty as Exports
...
instance ToResourceProperties LineChartDefaultSeriesSettingsProperty where
  toResourceProperties LineChartDefaultSeriesSettingsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.LineChartDefaultSeriesSettings",
