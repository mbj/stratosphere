module Stratosphere.QuickSight.Dashboard.IntegerValueWhenUnsetConfigurationProperty (
...
instance ToResourceProperties IntegerValueWhenUnsetConfigurationProperty where
  toResourceProperties
    IntegerValueWhenUnsetConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.IntegerValueWhenUnsetConfiguration",
