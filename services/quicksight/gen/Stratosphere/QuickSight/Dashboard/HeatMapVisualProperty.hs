module Stratosphere.QuickSight.Dashboard.HeatMapVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.HeatMapConfigurationProperty as Exports
...
instance ToResourceProperties HeatMapVisualProperty where
  toResourceProperties HeatMapVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.HeatMapVisual",
