module Stratosphere.QuickSight.Dashboard.ImageInteractionOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ImageMenuOptionProperty as Exports
...
instance ToResourceProperties ImageInteractionOptionsProperty where
  toResourceProperties ImageInteractionOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.ImageInteractionOptions",
