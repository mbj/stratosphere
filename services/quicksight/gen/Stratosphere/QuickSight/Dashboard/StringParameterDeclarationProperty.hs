module Stratosphere.QuickSight.Dashboard.StringParameterDeclarationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.StringDefaultValuesProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.StringValueWhenUnsetConfigurationProperty as Exports
...
instance ToResourceProperties StringParameterDeclarationProperty where
  toResourceProperties StringParameterDeclarationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.StringParameterDeclaration",
