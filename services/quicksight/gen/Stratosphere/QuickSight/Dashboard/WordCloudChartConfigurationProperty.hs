module Stratosphere.QuickSight.Dashboard.WordCloudChartConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.WordCloudFieldWellsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.WordCloudOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.WordCloudSortConfigurationProperty as Exports
...
data WordCloudChartConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-wordcloudchartconfiguration.html>
    WordCloudChartConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties WordCloudChartConfigurationProperty where
  toResourceProperties WordCloudChartConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.WordCloudChartConfiguration",
...
instance Property "Interactions" WordCloudChartConfigurationProperty where
  type PropertyType "Interactions" WordCloudChartConfigurationProperty = VisualInteractionOptionsProperty
  set newValue WordCloudChartConfigurationProperty {..}
    = WordCloudChartConfigurationProperty
