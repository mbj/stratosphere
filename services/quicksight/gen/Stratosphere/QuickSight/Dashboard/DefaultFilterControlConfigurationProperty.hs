module Stratosphere.QuickSight.Dashboard.DefaultFilterControlConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.DefaultFilterControlOptionsProperty as Exports
...
instance ToResourceProperties DefaultFilterControlConfigurationProperty where
  toResourceProperties DefaultFilterControlConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DefaultFilterControlConfiguration",
