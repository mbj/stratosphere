module Stratosphere.QuickSight.Dashboard.PivotTableOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.PivotTableRowsLabelOptionsProperty as Exports
...
instance ToResourceProperties PivotTableOptionsProperty where
  toResourceProperties PivotTableOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.PivotTableOptions",
