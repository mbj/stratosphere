module Stratosphere.QuickSight.Dashboard.ScatterPlotCategoricallyAggregatedFieldWellsProperty (
        module Exports,
...
instance ToResourceProperties ScatterPlotCategoricallyAggregatedFieldWellsProperty where
  toResourceProperties
    ScatterPlotCategoricallyAggregatedFieldWellsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.ScatterPlotCategoricallyAggregatedFieldWells",
