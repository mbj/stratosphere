module Stratosphere.QuickSight.Dashboard.GeospatialLayerJoinDefinitionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GeospatialLayerColorFieldProperty as Exports
...
instance ToResourceProperties GeospatialLayerJoinDefinitionProperty where
  toResourceProperties GeospatialLayerJoinDefinitionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GeospatialLayerJoinDefinition",
