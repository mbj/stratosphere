module Stratosphere.QuickSight.Dashboard.BarChartVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.BarChartConfigurationProperty as Exports
...
instance ToResourceProperties BarChartVisualProperty where
  toResourceProperties BarChartVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.BarChartVisual",
