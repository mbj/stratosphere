module Stratosphere.QuickSight.Dashboard.RadarChartVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.RadarChartConfigurationProperty as Exports
...
instance ToResourceProperties RadarChartVisualProperty where
  toResourceProperties RadarChartVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.RadarChartVisual",
