module Stratosphere.QuickSight.Dashboard.PluginVisualProperty (
        module Exports, PluginVisualProperty(..), mkPluginVisualProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.PluginVisualConfigurationProperty as Exports
...
instance ToResourceProperties PluginVisualProperty where
  toResourceProperties PluginVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.PluginVisual",
