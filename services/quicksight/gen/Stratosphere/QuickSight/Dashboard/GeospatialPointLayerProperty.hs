module Stratosphere.QuickSight.Dashboard.GeospatialPointLayerProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GeospatialPointStyleProperty as Exports
...
instance ToResourceProperties GeospatialPointLayerProperty where
  toResourceProperties GeospatialPointLayerProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GeospatialPointLayer",
