module Stratosphere.QuickSight.Dashboard.SheetDefinitionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.FilterControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.LayoutProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ParameterControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.SheetControlLayoutProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.SheetImageProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.SheetTextBoxProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.VisualProperty as Exports
...
instance ToResourceProperties SheetDefinitionProperty where
  toResourceProperties SheetDefinitionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.SheetDefinition",
