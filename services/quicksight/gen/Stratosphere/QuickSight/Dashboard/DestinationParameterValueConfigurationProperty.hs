module Stratosphere.QuickSight.Dashboard.DestinationParameterValueConfigurationProperty (
...
instance ToResourceProperties DestinationParameterValueConfigurationProperty where
  toResourceProperties
    DestinationParameterValueConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DestinationParameterValueConfiguration",
