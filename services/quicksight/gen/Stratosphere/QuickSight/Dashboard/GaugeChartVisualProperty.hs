module Stratosphere.QuickSight.Dashboard.GaugeChartVisualProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartConditionalFormattingProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartConfigurationProperty as Exports
...
instance ToResourceProperties GaugeChartVisualProperty where
  toResourceProperties GaugeChartVisualProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GaugeChartVisual",
