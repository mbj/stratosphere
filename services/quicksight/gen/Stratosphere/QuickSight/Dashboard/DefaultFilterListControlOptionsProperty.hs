module Stratosphere.QuickSight.Dashboard.DefaultFilterListControlOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.ListControlDisplayOptionsProperty as Exports
...
instance ToResourceProperties DefaultFilterListControlOptionsProperty where
  toResourceProperties DefaultFilterListControlOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.DefaultFilterListControlOptions",
