module Stratosphere.QuickSight.Dashboard.KPIActualValueConditionalFormattingProperty (
...
data KPIActualValueConditionalFormattingProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-kpiactualvalueconditionalformatting.html>
    KPIActualValueConditionalFormattingProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties KPIActualValueConditionalFormattingProperty where
  toResourceProperties
    KPIActualValueConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.KPIActualValueConditionalFormatting",
