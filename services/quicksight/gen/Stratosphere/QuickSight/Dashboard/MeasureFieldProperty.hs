module Stratosphere.QuickSight.Dashboard.MeasureFieldProperty (
        module Exports, MeasureFieldProperty(..), mkMeasureFieldProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.CalculatedMeasureFieldProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.CategoricalMeasureFieldProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.DateMeasureFieldProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.NumericalMeasureFieldProperty as Exports
...
instance ToResourceProperties MeasureFieldProperty where
  toResourceProperties MeasureFieldProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.MeasureField",
