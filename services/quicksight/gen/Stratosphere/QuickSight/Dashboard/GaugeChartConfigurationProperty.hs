module Stratosphere.QuickSight.Dashboard.GaugeChartConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartColorConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartFieldWellsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Dashboard.GaugeChartOptionsProperty as Exports
...
instance ToResourceProperties GaugeChartConfigurationProperty where
  toResourceProperties GaugeChartConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Dashboard.GaugeChartConfiguration",
