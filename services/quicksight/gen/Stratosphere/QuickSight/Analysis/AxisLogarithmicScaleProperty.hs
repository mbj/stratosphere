module Stratosphere.QuickSight.Analysis.AxisLogarithmicScaleProperty (
...
data AxisLogarithmicScaleProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-axislogarithmicscale.html>
    AxisLogarithmicScaleProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties AxisLogarithmicScaleProperty where
  toResourceProperties AxisLogarithmicScaleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.AxisLogarithmicScale",
