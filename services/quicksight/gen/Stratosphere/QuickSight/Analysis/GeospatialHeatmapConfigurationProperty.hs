module Stratosphere.QuickSight.Analysis.GeospatialHeatmapConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.GeospatialHeatmapColorScaleProperty as Exports
...
instance ToResourceProperties GeospatialHeatmapConfigurationProperty where
  toResourceProperties GeospatialHeatmapConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.GeospatialHeatmapConfiguration",
