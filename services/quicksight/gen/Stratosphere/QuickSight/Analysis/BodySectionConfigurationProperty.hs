module Stratosphere.QuickSight.Analysis.BodySectionConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.BodySectionContentProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.BodySectionRepeatConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.SectionPageBreakConfigurationProperty as Exports
...
instance ToResourceProperties BodySectionConfigurationProperty where
  toResourceProperties BodySectionConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.BodySectionConfiguration",
