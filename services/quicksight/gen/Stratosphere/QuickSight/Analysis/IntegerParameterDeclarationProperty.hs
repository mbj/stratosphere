module Stratosphere.QuickSight.Analysis.IntegerParameterDeclarationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.IntegerDefaultValuesProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.IntegerValueWhenUnsetConfigurationProperty as Exports
...
data IntegerParameterDeclarationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-integerparameterdeclaration.html>
    IntegerParameterDeclarationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties IntegerParameterDeclarationProperty where
  toResourceProperties IntegerParameterDeclarationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.IntegerParameterDeclaration",
