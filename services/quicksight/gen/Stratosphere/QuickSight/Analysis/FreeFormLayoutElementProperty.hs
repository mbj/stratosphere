module Stratosphere.QuickSight.Analysis.FreeFormLayoutElementProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FreeFormLayoutElementBackgroundStyleProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FreeFormLayoutElementBorderStyleProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.LoadingAnimationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.SheetElementRenderingRuleProperty as Exports
...
instance ToResourceProperties FreeFormLayoutElementProperty where
  toResourceProperties FreeFormLayoutElementProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.FreeFormLayoutElement",
