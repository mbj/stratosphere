module Stratosphere.QuickSight.Analysis.ConditionalFormattingGradientColorProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.GradientColorProperty as Exports
...
instance ToResourceProperties ConditionalFormattingGradientColorProperty where
  toResourceProperties
    ConditionalFormattingGradientColorProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.ConditionalFormattingGradientColor",
