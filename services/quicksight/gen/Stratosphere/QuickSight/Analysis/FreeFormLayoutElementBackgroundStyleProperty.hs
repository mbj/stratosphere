module Stratosphere.QuickSight.Analysis.FreeFormLayoutElementBackgroundStyleProperty (
...
instance ToResourceProperties FreeFormLayoutElementBackgroundStyleProperty where
  toResourceProperties
    FreeFormLayoutElementBackgroundStyleProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.FreeFormLayoutElementBackgroundStyle",
