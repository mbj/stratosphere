module Stratosphere.QuickSight.Analysis.DecimalParameterDeclarationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.DecimalDefaultValuesProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.DecimalValueWhenUnsetConfigurationProperty as Exports
...
instance ToResourceProperties DecimalParameterDeclarationProperty where
  toResourceProperties DecimalParameterDeclarationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.DecimalParameterDeclaration",
