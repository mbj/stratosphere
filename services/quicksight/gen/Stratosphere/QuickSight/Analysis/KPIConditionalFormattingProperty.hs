module Stratosphere.QuickSight.Analysis.KPIConditionalFormattingProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.KPIConditionalFormattingOptionProperty as Exports
...
instance ToResourceProperties KPIConditionalFormattingProperty where
  toResourceProperties KPIConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.KPIConditionalFormatting",
