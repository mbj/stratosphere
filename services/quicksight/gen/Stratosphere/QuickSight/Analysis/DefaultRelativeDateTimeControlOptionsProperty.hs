module Stratosphere.QuickSight.Analysis.DefaultRelativeDateTimeControlOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.RelativeDateTimeControlDisplayOptionsProperty as Exports
...
instance ToResourceProperties DefaultRelativeDateTimeControlOptionsProperty where
  toResourceProperties
    DefaultRelativeDateTimeControlOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.DefaultRelativeDateTimeControlOptions",
