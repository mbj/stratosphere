module Stratosphere.QuickSight.Analysis.CustomValuesConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.CustomParameterValuesProperty as Exports
...
instance ToResourceProperties CustomValuesConfigurationProperty where
  toResourceProperties CustomValuesConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.CustomValuesConfiguration",
