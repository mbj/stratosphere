module Stratosphere.QuickSight.Analysis.ReferenceLineStaticDataConfigurationProperty (
...
instance ToResourceProperties ReferenceLineStaticDataConfigurationProperty where
  toResourceProperties
    ReferenceLineStaticDataConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.ReferenceLineStaticDataConfiguration",
