module Stratosphere.QuickSight.Analysis.PluginVisualItemsLimitConfigurationProperty (
...
instance ToResourceProperties PluginVisualItemsLimitConfigurationProperty where
  toResourceProperties
    PluginVisualItemsLimitConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.PluginVisualItemsLimitConfiguration",
