module Stratosphere.QuickSight.Analysis.GaugeChartConditionalFormattingProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.GaugeChartConditionalFormattingOptionProperty as Exports
...
instance ToResourceProperties GaugeChartConditionalFormattingProperty where
  toResourceProperties GaugeChartConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.GaugeChartConditionalFormatting",
