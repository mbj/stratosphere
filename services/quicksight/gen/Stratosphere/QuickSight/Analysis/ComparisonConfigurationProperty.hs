module Stratosphere.QuickSight.Analysis.ComparisonConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ComparisonFormatConfigurationProperty as Exports
...
instance ToResourceProperties ComparisonConfigurationProperty where
  toResourceProperties ComparisonConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.ComparisonConfiguration",
