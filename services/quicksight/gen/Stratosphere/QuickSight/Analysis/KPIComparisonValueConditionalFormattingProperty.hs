module Stratosphere.QuickSight.Analysis.KPIComparisonValueConditionalFormattingProperty (
        module Exports,
...
instance ToResourceProperties KPIComparisonValueConditionalFormattingProperty where
  toResourceProperties
    KPIComparisonValueConditionalFormattingProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.KPIComparisonValueConditionalFormatting",
