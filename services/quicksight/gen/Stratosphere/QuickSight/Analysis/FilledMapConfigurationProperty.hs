module Stratosphere.QuickSight.Analysis.FilledMapConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FilledMapFieldWellsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FilledMapSortConfigurationProperty as Exports
...
instance ToResourceProperties FilledMapConfigurationProperty where
  toResourceProperties FilledMapConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.FilledMapConfiguration",
