module Stratosphere.QuickSight.Analysis.CategoryFilterConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.CustomFilterConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.CustomFilterListConfigurationProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FilterListConfigurationProperty as Exports
...
instance ToResourceProperties CategoryFilterConfigurationProperty where
  toResourceProperties CategoryFilterConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.CategoryFilterConfiguration",
