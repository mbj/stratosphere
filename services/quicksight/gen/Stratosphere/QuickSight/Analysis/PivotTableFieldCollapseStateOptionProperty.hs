module Stratosphere.QuickSight.Analysis.PivotTableFieldCollapseStateOptionProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.PivotTableFieldCollapseStateTargetProperty as Exports
...
instance ToResourceProperties PivotTableFieldCollapseStateOptionProperty where
  toResourceProperties
    PivotTableFieldCollapseStateOptionProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.PivotTableFieldCollapseStateOption",
