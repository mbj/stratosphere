module Stratosphere.QuickSight.Analysis.VisualSubtitleLabelOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.LongFormatTextProperty as Exports
...
instance ToResourceProperties VisualSubtitleLabelOptionsProperty where
  toResourceProperties VisualSubtitleLabelOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.VisualSubtitleLabelOptions",
