module Stratosphere.QuickSight.Analysis.PivotTableTotalOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.PivotTotalOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.SubtotalOptionsProperty as Exports
...
instance ToResourceProperties PivotTableTotalOptionsProperty where
  toResourceProperties PivotTableTotalOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.PivotTableTotalOptions",
