module Stratosphere.QuickSight.Analysis.HeatMapSortConfigurationProperty (
...
data HeatMapSortConfigurationProperty
  = -- | See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-heatmapsortconfiguration.html>
    HeatMapSortConfigurationProperty {haddock_workaround_ :: (),
...
instance ToResourceProperties HeatMapSortConfigurationProperty where
  toResourceProperties HeatMapSortConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.HeatMapSortConfiguration",
