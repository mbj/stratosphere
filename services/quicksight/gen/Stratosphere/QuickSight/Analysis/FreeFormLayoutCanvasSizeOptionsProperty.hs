module Stratosphere.QuickSight.Analysis.FreeFormLayoutCanvasSizeOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.FreeFormLayoutScreenCanvasSizeOptionsProperty as Exports
...
instance ToResourceProperties FreeFormLayoutCanvasSizeOptionsProperty where
  toResourceProperties FreeFormLayoutCanvasSizeOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.FreeFormLayoutCanvasSizeOptions",
