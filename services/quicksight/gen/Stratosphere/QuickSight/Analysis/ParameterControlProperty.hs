module Stratosphere.QuickSight.Analysis.ParameterControlProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterDateTimePickerControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterDropDownControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterListControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterSliderControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterTextAreaControlProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ParameterTextFieldControlProperty as Exports
...
instance ToResourceProperties ParameterControlProperty where
  toResourceProperties ParameterControlProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.ParameterControl",
