module Stratosphere.QuickSight.Analysis.BarChartFieldWellsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.BarChartAggregatedFieldWellsProperty as Exports
...
instance ToResourceProperties BarChartFieldWellsProperty where
  toResourceProperties BarChartFieldWellsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.BarChartFieldWells",
