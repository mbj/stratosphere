module Stratosphere.QuickSight.Analysis.BodySectionDynamicNumericDimensionConfigurationProperty (
        module Exports,
...
instance ToResourceProperties BodySectionDynamicNumericDimensionConfigurationProperty where
  toResourceProperties
    BodySectionDynamicNumericDimensionConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.BodySectionDynamicNumericDimensionConfiguration",
