module Stratosphere.QuickSight.Analysis.ForecastScenarioProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.WhatIfPointScenarioProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.WhatIfRangeScenarioProperty as Exports
...
instance ToResourceProperties ForecastScenarioProperty where
  toResourceProperties ForecastScenarioProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.ForecastScenario",
