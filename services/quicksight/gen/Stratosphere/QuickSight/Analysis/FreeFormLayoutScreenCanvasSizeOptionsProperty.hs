module Stratosphere.QuickSight.Analysis.FreeFormLayoutScreenCanvasSizeOptionsProperty (
...
instance ToResourceProperties FreeFormLayoutScreenCanvasSizeOptionsProperty where
  toResourceProperties
    FreeFormLayoutScreenCanvasSizeOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.FreeFormLayoutScreenCanvasSizeOptions",
