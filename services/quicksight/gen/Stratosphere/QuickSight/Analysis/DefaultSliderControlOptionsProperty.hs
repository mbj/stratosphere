module Stratosphere.QuickSight.Analysis.DefaultSliderControlOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.SliderControlDisplayOptionsProperty as Exports
...
instance ToResourceProperties DefaultSliderControlOptionsProperty where
  toResourceProperties DefaultSliderControlOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.DefaultSliderControlOptions",
