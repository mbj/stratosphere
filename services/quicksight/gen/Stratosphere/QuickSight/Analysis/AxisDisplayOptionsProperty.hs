module Stratosphere.QuickSight.Analysis.AxisDisplayOptionsProperty (
...
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.AxisDataOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.AxisTickLabelOptionsProperty as Exports
import {-# SOURCE #-} Stratosphere.QuickSight.Analysis.ScrollBarOptionsProperty as Exports
...
instance ToResourceProperties AxisDisplayOptionsProperty where
  toResourceProperties AxisDisplayOptionsProperty {..}
    = ResourceProperties
        {awsType = "AWS::QuickSight::Analysis.AxisDisplayOptions",
