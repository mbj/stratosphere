module Stratosphere.VpcLattice.Listener.FixedResponseProperty (
...
data FixedResponseProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-listener-fixedresponse.html>
    FixedResponseProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-vpclattice-listener-fixedresponse.html#cfn-vpclattice-listener-fixedresponse-statuscode>
...
instance ToResourceProperties FixedResponseProperty where
  toResourceProperties FixedResponseProperty {..}
    = ResourceProperties
        {awsType = "AWS::VpcLattice::Listener.FixedResponse",
