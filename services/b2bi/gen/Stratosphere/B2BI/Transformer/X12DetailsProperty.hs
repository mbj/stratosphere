module Stratosphere.B2BI.Transformer.X12DetailsProperty (
...
data X12DetailsProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-b2bi-transformer-x12details.html>
    X12DetailsProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-b2bi-transformer-x12details.html#cfn-b2bi-transformer-x12details-transactionset>
...
mkX12DetailsProperty
  = X12DetailsProperty
      {transactionSet = Prelude.Nothing, version = Prelude.Nothing}
instance ToResourceProperties X12DetailsProperty where
  toResourceProperties X12DetailsProperty {..}
    = ResourceProperties
        {awsType = "AWS::B2BI::Transformer.X12Details",
