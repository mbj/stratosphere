module Stratosphere.QBusiness.DataSource.DocumentAttributeValueProperty (
...
data DocumentAttributeValueProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-qbusiness-datasource-documentattributevalue.html>
    DocumentAttributeValueProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-qbusiness-datasource-documentattributevalue.html#cfn-qbusiness-datasource-documentattributevalue-datevalue>
...
instance ToResourceProperties DocumentAttributeValueProperty where
  toResourceProperties DocumentAttributeValueProperty {..}
    = ResourceProperties
        {awsType = "AWS::QBusiness::DataSource.DocumentAttributeValue",
