module Stratosphere.EMR.InstanceFleetConfig.EbsConfigurationProperty (
...
import {-# SOURCE #-} Stratosphere.EMR.InstanceFleetConfig.EbsBlockDeviceConfigProperty as Exports
...
data EbsConfigurationProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-instancefleetconfig-ebsconfiguration.html>
    EbsConfigurationProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-instancefleetconfig-ebsconfiguration.html#cfn-elasticmapreduce-instancefleetconfig-ebsconfiguration-ebsblockdeviceconfigs>
...
instance ToResourceProperties EbsConfigurationProperty where
  toResourceProperties EbsConfigurationProperty {..}
    = ResourceProperties
        {awsType = "AWS::EMR::InstanceFleetConfig.EbsConfiguration",
