...
data IamActionDefinitionProperty
  = IamActionDefinitionProperty {groups :: (Prelude.Maybe (ValueList (Value Prelude.Text))),
...
instance Property "Groups" IamActionDefinitionProperty where
  type PropertyType "Groups" IamActionDefinitionProperty = ValueList (Value Prelude.Text)
...
instance Property "Roles" IamActionDefinitionProperty where
  type PropertyType "Roles" IamActionDefinitionProperty = ValueList (Value Prelude.Text)
  set newValue IamActionDefinitionProperty {..}
    = IamActionDefinitionProperty {roles = Prelude.pure newValue, ..}
instance Property "Users" IamActionDefinitionProperty where
  type PropertyType "Users" IamActionDefinitionProperty = ValueList (Value Prelude.Text)
  set newValue IamActionDefinitionProperty {..}
