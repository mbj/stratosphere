module Stratosphere.NetworkManager.ConnectAttachment.ProposedSegmentChangeProperty (
...
data ProposedSegmentChangeProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkmanager-connectattachment-proposedsegmentchange.html>
    ProposedSegmentChangeProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-networkmanager-connectattachment-proposedsegmentchange.html#cfn-networkmanager-connectattachment-proposedsegmentchange-attachmentpolicyrulenumber>
...
instance ToResourceProperties ProposedSegmentChangeProperty where
  toResourceProperties ProposedSegmentChangeProperty {..}
    = ResourceProperties
        {awsType = "AWS::NetworkManager::ConnectAttachment.ProposedSegmentChange",
