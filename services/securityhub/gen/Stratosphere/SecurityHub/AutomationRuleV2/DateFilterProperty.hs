module Stratosphere.SecurityHub.AutomationRuleV2.DateFilterProperty (
        module Exports, DateFilterProperty(..), mkDateFilterProperty
    ) where
import qualified Data.Aeson as JSON
import qualified Stratosphere.Prelude as Prelude
import Stratosphere.Property
import {-# SOURCE #-} Stratosphere.SecurityHub.AutomationRuleV2.DateRangeProperty as Exports
...
instance ToResourceProperties DateFilterProperty where
  toResourceProperties DateFilterProperty {..}
    = ResourceProperties
        {awsType = "AWS::SecurityHub::AutomationRuleV2.DateFilter",
