module Stratosphere.WAFv2.RuleGroup.HeaderMatchPatternProperty (
...
data HeaderMatchPatternProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-headermatchpattern.html>
    HeaderMatchPatternProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-headermatchpattern.html#cfn-wafv2-rulegroup-headermatchpattern-all>
...
instance ToResourceProperties HeaderMatchPatternProperty where
  toResourceProperties HeaderMatchPatternProperty {..}
    = ResourceProperties
        {awsType = "AWS::WAFv2::RuleGroup.HeaderMatchPattern",
