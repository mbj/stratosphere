module Stratosphere.WAFv2.WebACL.SingleHeaderProperty (
...
data SingleHeaderProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-webacl-singleheader.html>
    SingleHeaderProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-webacl-singleheader.html#cfn-wafv2-webacl-singleheader-name>
...
instance ToResourceProperties SingleHeaderProperty where
  toResourceProperties SingleHeaderProperty {..}
    = ResourceProperties
        {awsType = "AWS::WAFv2::WebACL.SingleHeader",
