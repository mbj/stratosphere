...
data CorsRuleProperty
  = CorsRuleProperty {allowedHeaders :: (Prelude.Maybe (ValueList (Value Prelude.Text))),
                      allowedMethods :: (Prelude.Maybe (ValueList (Value Prelude.Text))),
                      allowedOrigins :: (Prelude.Maybe (ValueList (Value Prelude.Text))),
...
instance Property "ExposeHeaders" CorsRuleProperty where
  type PropertyType "ExposeHeaders" CorsRuleProperty = ValueList (Value Prelude.Text)
  set newValue CorsRuleProperty {..}
