module Stratosphere.EC2.EC2Fleet.BlockDeviceMappingProperty (
...
import {-# SOURCE #-} Stratosphere.EC2.EC2Fleet.EbsBlockDeviceProperty as Exports
...
instance ToResourceProperties BlockDeviceMappingProperty where
  toResourceProperties BlockDeviceMappingProperty {..}
    = ResourceProperties
        {awsType = "AWS::EC2::EC2Fleet.BlockDeviceMapping",
