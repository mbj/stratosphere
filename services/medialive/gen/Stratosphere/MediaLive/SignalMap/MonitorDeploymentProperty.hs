...
data MonitorDeploymentProperty
  = -- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-signalmap-monitordeployment.html>
    MonitorDeploymentProperty {-- |See: <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-signalmap-monitordeployment.html#cfn-medialive-signalmap-monitordeployment-detailsuri>
...
mkMonitorDeploymentProperty status
  = MonitorDeploymentProperty
      {status = status, detailsUri = Prelude.Nothing,
