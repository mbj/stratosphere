module Stratosphere.Omics.Workflow.DefinitionRepositoryProperty (
...
import {-# SOURCE #-} Stratosphere.Omics.Workflow.SourceReferenceProperty as Exports
...
instance ToResourceProperties DefinitionRepositoryProperty where
  toResourceProperties DefinitionRepositoryProperty {..}
    = ResourceProperties
        {awsType = "AWS::Omics::Workflow.DefinitionRepository",
