...
itedmoeEvents :: Lens' IoTEventsDetectorModelOnEnter (Maybe [IoTEventsDetectorModelEvent])
itedmoeEvents = lens _ioTEventsDetectorModelOnEnterEvents (\s a -> s { _ioTEventsDetectorModelOnEnterEvents = a })
