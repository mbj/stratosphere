...
instance ToJSON KinesisFirehoseDeliveryStreamExtendedS3DestinationConfiguration where
  toJSON KinesisFirehoseDeliveryStreamExtendedS3DestinationConfiguration{..} =
    object $
    catMaybes
    [ Just ("BucketARN" .= _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationBucketARN)
    , Just ("BufferingHints" .= _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationBufferingHints)
    , ("CloudWatchLoggingOptions" .=) <$> _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationCloudWatchLoggingOptions
    , Just ("CompressionFormat" .= _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationCompressionFormat)
    , ("EncryptionConfiguration" .=) <$> _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationEncryptionConfiguration
    , Just ("Prefix" .= _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationPrefix)
    , ("ProcessingConfiguration" .=) <$> _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationProcessingConfiguration
    , Just ("RoleARN" .= _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationRoleARN)
    , ("S3BackupConfiguration" .=) <$> _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationS3BackupConfiguration
    , ("S3BackupMode" .=) <$> _kinesisFirehoseDeliveryStreamExtendedS3DestinationConfigurationS3BackupMode
    ]
...
-- | http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-kinesisdeliverystream-extendeds3destinationconfiguration.html#cfn-kinesisfirehose-kinesisdeliverystream-processingccnfiguration
