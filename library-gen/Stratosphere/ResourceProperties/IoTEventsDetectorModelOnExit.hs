...
itedmoeEvents :: Lens' IoTEventsDetectorModelOnExit (Maybe [IoTEventsDetectorModelEvent])
itedmoeEvents = lens _ioTEventsDetectorModelOnExitEvents (\s a -> s { _ioTEventsDetectorModelOnExitEvents = a })
