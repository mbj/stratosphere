...
data Stack =
  ...
  , _stackParameters :: Maybe (Val ParameterMap)
  , _stackResourceTags :: Maybe [Val ResourceTag]
...
-- nested stacks.
sParameters :: Lens' Stack (Maybe (Val ParameterMap))
...
sResourceTags :: Lens' Stack (Maybe [Val ResourceTag])
